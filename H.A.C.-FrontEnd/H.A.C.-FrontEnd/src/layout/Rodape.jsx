      ...
      <div className="container">
        <div className="row g-4 mb-5">
          ...
          <div className="col-6 col-md-2">
            <h5 className="text-white mb-3 fw-bold">Explorar</h5>
            <ul className="list-unstyled small text-secondary">
              ...
              <li className="mb-2"><Link to="/catalogo?cat=teclados" className="text-reset text-decoration-none hover-primary">Teclados</Link></li>
              <li className="mb-2"><Link to="/catalogo?cat=mouses" className="text-reset text-decoration-none hover-primary">Mouses</Link></li>
              <li className="mb-2"><Link to="/catalogo?cat=headsets" className="text-reset text-decoration-none hover-primary">Headsets</Link></li>
            </ul>
          </div>

          {/* Suporte */}
          <div className="col-6 col-md-2">
            <h5 className="text-white mb-3 fw-bold">Suporte</h5>
            <ul className="list-unstyled small text-secondary">
              <li className="mb-2"><Link to="/meus-pedidos" className="text-reset text-decoration-none hover-primary">Meus Pedidos</Link></li>
              <li className="mb-2"><Link to="/rastreamento/123" className="text-reset text-decoration-none hover-primary">Rastreamento</Link></li>
              <li className="mb-2"><Link to="/ajuda" className="text-reset text-decoration-none hover-primary">Central de Ajuda</Link></li>
              <li className="mb-2"><Link to="/contato" className="text-reset text-decoration-none hover-primary">Fale Conosco</Link></li>
            </ul>
          </div>
