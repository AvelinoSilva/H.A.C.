      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', position: 'sticky', top: '100px' }}>
          ...
          <div style={{ 
            ...
            <p style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px', color: 'var(--text-secondary)', fontWeight: '600' }}>
              <Info size={14} /> Nota Técnica para a Banca:
            </p>
            Esta tela representa a visualização de eventos assíncronos de um pedido. 
            Em um ambiente real, cada atualização no histórico seria disparada por um 
            serviço de mensageria (como RabbitMQ) e entregue ao front-end via WebSocket/SSE.
          </div>
        </div>
      </div>
    </div>
