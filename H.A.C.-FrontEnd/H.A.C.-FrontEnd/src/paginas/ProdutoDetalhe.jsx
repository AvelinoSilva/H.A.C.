        ...
        <div className="col-12 col-lg-6">
          ...
          <div className="card glass border-secondary rounded-4 overflow-hidden">
            ...
            <div className="card-body p-4 text-secondary">
              {abaAtiva === 'descricao' ? (
                <p className="mb-0 lh-lg">{produto.descricaoCompleta}</p>
              ) : (
                <div className="row g-3">
                  {Object.entries(produto.especificacoes).map(([key, val]) => (
                    <div key={key} className="col-12 col-md-6">
                      <div className="p-3 rounded-3 bg-dark bg-opacity-50 border border-secondary border-opacity-50">
                        <small className="text-primary fw-bold d-block mb-1 text-uppercase small" style={{ letterSpacing: '1px' }}>{key}</small>
                        <span className="text-white fw-medium">{val}</span>
                      </div>
                    </div>
                  ))}
                </div>
